...
public class audiencenode extends Botsolver {
	...
	public void audienceopener() throws InterruptedException {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div[4]/div/div/div[2]/div[2]/button[1]")));
		driver.findElement(By.xpath("//*[@id='root']/div/div[4]/div/div/div[2]/div[2]/button[1]")).click();
//		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div[2]/div[3]/div[3]/div[1]/div[1]/h3")).click();
Thread.sleep(3000);
